        ...
        <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
                ...
                <ul>
                    ...
                    <li><span className="font-bold">Notarization to:</span><span className="text-grey-500">{L0}</span></li>
                </ul>
            </div>
        </div>
    )
            ...
            {data && <div className="grid max-h-screen grid-cols-2">
                ...
                <div className="pl-4">
                    ...
                    {subscriptionsKeys &&<><h2 className="pb-4 text-xl font-bold mt-4">Subscriptions</h2>
                        <dl>
                            {subscriptionsKeys && subscriptionsKeys.map((s,i)=> <SubscriptionCard key={i} label={s} L0={data?.identity.L0} value={subscriptions[s]}/>)}
                        </dl>
                    </>}
                </div>
            </div>
