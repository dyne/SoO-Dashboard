...
const OraclesConsensusPost: NextPage = () => {
    ...
    const [endpoint, setEndpoint] = useState('https://swarm1.dyne.org:20003/api/zenswarm-post-6-rand-oracles.chain')
    ...
    return (<>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
            <form className="grid grid-cols-1 md:col-span-7" onSubmit={consesusPost}>
